...
Use this skill for tasks involving ODAS protocol handling,
remote odaslive control, source lifecycle transitions,
and recording correctness.
...
5. Validate UI update path from backend callbacks to QML
   bindings.
